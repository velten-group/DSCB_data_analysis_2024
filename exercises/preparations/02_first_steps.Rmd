...
<mark>**Your task**: Please generate a html version of this file (following the steps described below) and *hand this in by November 1 via moodle*.</mark>
...
<mark>**Task 10: Knit the .Rmd file with all your changes and solutions by clicking on the "Knit button" for the tasks and hand in the html via moodle. Make sure to change the author name to your name before knitting. Don't worry if you encounter problems, we will jointly go through the file on the first day of the course ** </mark>
